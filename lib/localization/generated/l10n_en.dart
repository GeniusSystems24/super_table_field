...
class SuperTableLocalizationEn extends SuperTableLocalization {
  SuperTableLocalizationEn([String locale = 'en']) : super(locale);
  ...
  String deleteRowBody(int rowNumber, String rowLabel) {
    return 'Row $rowNumber ($rowLabel) will be permanently removed. This cannot be undone.';
  }
  ...
  String validationIssueCount(int count, String pluralSuffix) {
    return '$count validation issue$pluralSuffix';
  }
  ...
  String issueCount(int count, String pluralSuffix) {
    return '$count issue$pluralSuffix';
  }

  @override
  String rowCount(int count, String pluralSuffix) {
    return '$count row$pluralSuffix';
  }

  @override
  String editableStatusHint(String rowCount) {
    return '$rowCount · ↵ edit · Tab next (new row at end) · ⌘↵ insert after · ⌘C/V JSON · ⌘Z undo';
  }

  @override
  String readableStatusHint(String rowCount, String expansionHint) {
    return '$rowCount · ⇧+arrows to range-select · right-click header for options · ⌘C copy$expansionHint';
  }
  ...
  String selectionStats(
    ...
    return 'Sum $sum · Avg $average · Min $min · Max $max · Count $count';
  }
  ...
  String copiedRowsCsv(int count) {
    return 'Copied $count rows as CSV';
  }

  @override
  String filledCells(int count, String pluralSuffix) {
    return 'Filled $count cell$pluralSuffix';
  }

  @override
  String copiedRowsJson(int count, String pluralSuffix) {
    return 'Copied $count row$pluralSuffix as JSON';
  }

  @override
  String rowIsNotObject(int rowNumber) {
    return 'Row $rowNumber is not an object';
  }
  ...
  String pastedBlockTooWide(int columnNumber) {
    return 'Pasted block is wider than the table (column $columnNumber doesn\'t exist)';
  }

  @override
  String cellError(int rowNumber, int columnNumber, String error) {
    return 'Cell $rowNumber×$columnNumber: $error';
  }
  ...
  String columnMustBeUniqueDuplicate(String column, int rowNumber) {
    return '\"$column\" must be unique - duplicates row $rowNumber';
  }

  @override
  String columnInvalidValue(String column) {
    return '\"$column\" has an invalid value';
  }
